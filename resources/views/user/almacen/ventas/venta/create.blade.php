...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'user/ventas','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}
<div class="row">
...
<div class="form-group">
	...
	<select name="pidarticulo" class="form-control selectpicker" id="pidarticulo" data-live-search="true">
		...
		<option value="{{$articulo->idproducto}}_{{$articulo->stock}}_{{$articulo->precio_promedio}}">{{$articulo->producto}}</option>
		@endforeach
	</select>

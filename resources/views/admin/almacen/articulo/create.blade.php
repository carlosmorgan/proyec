...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'admin/articulo','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
            {{Form::token()}}
<div class="row">
...
<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
	...
	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
		 <div class="form-group">
            	...
            	<input type="text" name="codigo" required value="{{old('codigo')}}" class="form-control" placeholder="codigo de barra...">
            </div>

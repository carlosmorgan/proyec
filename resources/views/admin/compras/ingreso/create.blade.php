...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'admin/compras','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}
<div class="row">
...
<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
		 <div class="form-group">
            	...
            	<input type="text" name="num_comprobante" required value="{{old('serie_comprobante')}}" class="form-control" placeholder="numero_comprobante...">
            </div>
...
<div class="form-group">
	...
	<select name="pidarticulo" class="form-control selectpicker" id="pidarticulo" data-live-search="true">
		...
		<option value="{{$articulo->idproducto}}">{{$articulo->producto}}</option>
		@endforeach
	</select>
...
<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
	...
	<table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
		<thead style="background-color: #81F7BE" >
			        <th>Opciones</th>
					<th>Articulos</th>
					<th>Cantidad</th>
					<th>Precio Compra</th>
		...
		<tfoot style="border-color: #190707">
			        <th>Total</th>
					<th></th>
					<th></th>
					<th></th>
...
function agregar(){
	...
	if(idarticulo!="" && cantidad!="" && cantidad>0 && precio_compra!="" && precio_venta!=""){
		...
		alert("Error al ingresar el detalle de la compra, revise los datos del articulo");
	}
}

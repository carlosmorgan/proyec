...
use App\Http\Requests\VentaAdminsFormRequest;
use App\VentaAdmins;
...
class VentaAdminsController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            ->paginate(7);
            return view('admin.ventas.index',["ventas"=>$ventas,"searchText"=>$query]);
        }
...
public function create()
{
  ...
  ->where('art.stock','>','0')
	...
	->get();
return view("admin.ventas.create",["personas"=>$personas, "articulos"=>$articulos]);
} 

public function store (VentaAdminsFormRequest $request)
    {
